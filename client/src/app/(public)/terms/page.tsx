...
const page = () => {
  return (
   <div className="bg-background text-foreground min-h-screen px-4 sm:px-6 py-12 sm:py-16">
      <div className="max-w-2xl mx-auto">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">Terms & Conditions</h1>
        <p className="text-foreground text-xs mb-10">Last updated: July 2026</p>
        ...
        <div className="space-y-8 text-sm text-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-foreground font-semibold text-base mb-2">2. Platform Role</h2>
            <p>
          ...
          <section>
            <h2 className="text-foreground font-semibold text-base mb-2">3. Brand Responsibilities</h2>
            <p>
          ...
          <section>
            <h2 className="text-foreground font-semibold text-base mb-2">4. Influencer Responsibilities</h2>
            <p>
          ...
          <section>
            <h2 className="text-foreground font-semibold text-base mb-2">5. Payments & Escrow</h2>
            <p>
          ...
          <section>
            <h2 className="text-foreground font-semibold text-base mb-2">6. Prohibited Conduct</h2>
            <p>
          ...
          <section>
            <h2 className="text-foreground font-semibold text-base mb-2">7. Account Suspension & Termination</h2>
            <p>
          ...
          <section>
            <h2 className="text-foreground font-semibold text-base mb-2">8. Limitation of Liability</h2>
            <p>
          ...
          <section>
            <h2 className="text-foreground font-semibold text-base mb-2">9. Changes to These Terms</h2>
            <p>
