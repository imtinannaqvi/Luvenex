...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen w-full bg-background text-foreground selection:bg-red-600 selection:text-foreground overflow-x-hidden">
      
      {/* Contact Banner Image - Fixed aspect ratio & contain to prevent face clipping */}
      <div className="w-full bg-black border-b border-[#262626] flex items-center justify-center overflow-hidden">
        <div className="w-full max-w-7xl aspect-[21/9] sm:aspect-[24/9] max-h-[400px] overflow-hidden">
          <img
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    disabled={submitting}
                    className="group py-4 px-10 bg-primary active:scale-[0.98] hover:text-black text-foreground text-md font-semibold transition-all disabled:opacity-50 cursor-pointer"
                  >
