...
export default function Footer() {
  ...
  return (
    <div className="relative w-full sm:min-h-screen bg-background text-foreground flex flex-col sm:justify-between p-6 sm:p-12 overflow-hidden selection:bg-white selection:text-black gap-10 sm:gap-0">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none overflow-hidden text-pink">
        <svg
      ...
      <footer className="relative z-10 w-full max-w-7xl mx-auto pt-6 border-t border-border-color/80 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-foreground/50">
        <div>
          <p className="tracking-wide text-green">
            © <span className="text-green font-medium">Luvenex LTD</span >. All Rights Reserved.
          </p>
        </div>

        {/* Quick Footer Policy Links */}
        <div className="flex items-center space-x-6 text-[11px] font-medium tracking-widest text-green uppercase">
        ...
        <div className="flex items-center space-x-3">
          <a href="#" aria-label="Facebook" className="w-8 h-8 rounded-full border border-border-color flex items-center justify-center hover:border-foreground hover:text-foreground transition-colors">
            <svg className="w-3.5 h-3.5 fill-green" viewBox="0 0 24 24">
          ...
          <a href="#" aria-label="Website" className="w-8 h-8 rounded-full border border-border-color flex items-center justify-center hover:border-foreground hover:text-foreground transition-colors">
            <svg className="w-3.5 h-3.5 fill-green stroke-current" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
